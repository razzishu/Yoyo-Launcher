...
package com.yoyo.launcher.graphics.theme
...
import com.yoyo.launcher.graphics.theme.MonoIconThemeFactory.MONO_THEME_CONTROLLER
import com.yoyo.launcher.graphics.theme.ThemePreference.ThemeValue
...
private constructor(
    ...
    constructor(
        ...
        prefs.addListener({ key ->
            if (key == LEGACY_MONO_THEME_ICON.sharedPrefKey) {
                setValue(if (prefs.get(LEGACY_MONO_THEME_ICON)) MONO_THEME_VALUE else null)
            }
    ...
    init {
        ...
        if (oldValue != null)
            prefs.remove(*(legacyThemeKeys.values).toTypedArray())
    ...
    companion object {
        ...
        @VisibleForTesting val LEGACY_MONO_THEME_ICON = backedUpItem("pref_allapps_themed_icons", false)
