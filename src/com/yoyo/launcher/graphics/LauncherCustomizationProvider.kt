...
import com.yoyo.launcher.BuildConfig.APPLICATION_ID
import com.yoyo.launcher.R
import com.yoyo.launcher.dagger.LauncherComponentProvider.appComponent
import com.yoyo.launcher.util.ContentProviderProxy
...
class LauncherCustomizationProvider : ContentProviderProxy() {
    ...
    private fun genericAccessException() =
        SecurityException(
            "Permission Denial: opening provider com.yoyo.launcher.graphics.LauncherCustomizationProvider (pid=${Binder.getCallingPid()}, uid=${Binder.getCallingUid()}) requires $BIND_WALLPAPER or $PERM_GRID_CONTROL"
        )
