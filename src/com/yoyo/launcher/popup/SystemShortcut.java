...
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_DISMISS_PREDICTION_UNDO;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_PRIVATE_SPACE_INSTALL_SYSTEM_SHORTCUT_TAP;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_PRIVATE_SPACE_UNINSTALL_SYSTEM_SHORTCUT_TAP;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_SYSTEM_SHORTCUT_APP_INFO_TAP;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_SYSTEM_SHORTCUT_DONT_SUGGEST_APP_TAP;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_SYSTEM_SHORTCUT_WIDGETS_TAP;
import static com.yoyo.launcher.widget.picker.model.data.WidgetPickerDataUtils.findAllWidgetsForPackageUser;
...
import com.yoyo.launcher.util.ActivityOptionsWrapper;
...
import com.yoyo.launcher.views.Snackbar;
import com.yoyo.launcher.widget.WidgetsBottomSheet;
import com.yoyo.launcher.widget.picker.model.data.WidgetPickerData;
...
public abstract class SystemShortcut<T extends ActivityContext> extends ItemInfo
    ...
    public static final Factory<ActivityContext> PRIVATE_PROFILE_INSTALL =
            (context, itemInfo, originalView) -> {
                ...
                if (itemInfo.getTargetComponent() == null
                        || !(itemInfo instanceof com.yoyo.launcher.model.data.AppInfo)
    ...
    public static final Factory<ActivityContext> INSTALL =
            (activity, itemInfo, originalView) -> {
                ...
                if (itemInfo instanceof com.yoyo.launcher.model.data.AppInfo appInfo) {
