...
import static com.yoyo.launcher.util.LooperExecutor.CALLER_ICON_CACHE;
...
import com.yoyo.launcher.widget.WidgetSections.WidgetSection;
...
public class IconCache extends BaseIconCache {
    ...
    public Drawable getFullResIcon(LauncherActivityInfo info) {
        return iconProvider.getIcon(info, fillResIconDpi);
    }

    public Drawable getFullResIcon(String packageName, UserHandle user) {
        try {
            ApplicationInfo appInfo = context.getPackageManager().getApplicationInfo(packageName, 0);
            return iconProvider.getIcon(appInfo);
        } catch (Exception e) {
            return iconProvider.getDefaultIcon(fillResIconDpi);
        }
    }

    @Override
    public Drawable getFullResIcon(ActivityInfo info) {
        return iconProvider.getIcon(info);
    }
