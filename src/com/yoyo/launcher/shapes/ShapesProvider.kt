...
package com.yoyo.launcher.shapes

import com.yoyo.launcher.R

object ShapesProvider {
    private const val CIRCLE_PATH = "M50 0A50 50,0,1,1,50 100A50 50,0,1,1,50 0"
    private const val SQUARE_PATH = "M20,0 H80 C91,0 100,9 100,20 V80 C100,91 91,100 80,100 H20 C9,100 0,91 0,80 V20 C0,9 9,0 20,0 Z"
    ...
    private const val PURE_SQUARE_PATH = "M0,0 H100 V100 H0 Z"
    ...
    private const val HEXAGON_PATH = "M50,0 L93.3,25 L93.3,75 L50,100 L6.7,75 L6.7,25 Z"
    private const val OCTAGON_PATH = "M30,0 L70,0 L100,30 L100,70 L70,100 L30,100 L0,70 L0,30 Z"
    private const val HEART_PATH = "M50,30 C50,30 50,30 50,30 C50,13 65,0 80,0 C95,0 100,15 100,30 C100,60 50,100 50,100 C50,100 0,60 0,30 C0,15 5,0 20,0 C35,0 50,13 50,30 Z"
    ...
    const val OCTAGON_KEY = "octagon"
    const val HEART_KEY = "heart"

    val iconShapes: Array<IconShapeModel> = arrayOf(
        IconShapeModel(
            key = CIRCLE_KEY,
        ...
        IconShapeModel(
            key = OCTAGON_KEY,
            titleId = R.string.octagon_shape_title,
            pathString = OCTAGON_PATH,
        ),
        IconShapeModel(
            key = HEART_KEY,
