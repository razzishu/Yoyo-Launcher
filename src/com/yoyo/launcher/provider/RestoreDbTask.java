...
package com.yoyo.launcher.provider;
...
import static com.yoyo.launcher.LauncherPrefs.APP_WIDGET_IDS;
import static com.yoyo.launcher.LauncherPrefs.IS_FIRST_LOAD_AFTER_RESTORE;
import static com.yoyo.launcher.LauncherPrefs.OLD_APP_WIDGET_IDS;
import static com.yoyo.launcher.LauncherPrefs.RESTORE_DEVICE;
...
import static com.yoyo.launcher.provider.LauncherDbUtils.dropTable;
import static com.yoyo.launcher.widget.LauncherWidgetHolder.APPWIDGET_HOST_ID;
...
import com.yoyo.launcher.model.LoaderTask;
import com.yoyo.launcher.model.ModelDbController;
...
import com.yoyo.launcher.util.LogConfig;
...
public class RestoreDbTask {
    ...
    protected int sanitizeDB(Context context, ModelDbController controller, SQLiteDatabase db,
        ...
        db.update(Favorites.TABLE_NAME, values, "itemType = ?",
                new String[]{Integer.toString(ITEM_TYPE_APPWIDGET)});
    ...
    private void restoreAppWidgetIds(Context context, ModelDbController controller,
        ...
        if (!WIDGETS_ENABLED) {
            ...
            host.deleteHost();
            launcherRestoreEventLogger.logFavoritesItemsRestoreFailed(ITEM_TYPE_APPWIDGET,
    ...
    protected static void maybeOverrideShortcuts(Context context, ModelDbController controller,
        ...
        try (Cursor c = db.query(Favorites.TABLE_NAME,
                ...
                String.format("%s=? AND %s=? AND ( %s )", ITEM_TYPE, Favorites.PROFILE_ID,
