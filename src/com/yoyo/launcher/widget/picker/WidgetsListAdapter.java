...
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_WIDGETSTRAY_APP_EXPANDED;
import static com.yoyo.launcher.recyclerview.ViewHolderBinder.POSITION_DEFAULT;
import static com.yoyo.launcher.recyclerview.ViewHolderBinder.POSITION_FIRST;
import static com.yoyo.launcher.recyclerview.ViewHolderBinder.POSITION_LAST;
import static com.yoyo.launcher.widget.BaseWidgetSheet.DEFAULT_MAX_HORIZONTAL_SPANS;
...
import com.yoyo.launcher.recyclerview.ViewHolderBinder;
import com.yoyo.launcher.util.LabelComparator;
...
import com.yoyo.launcher.widget.model.WidgetListSpaceEntry;
import com.yoyo.launcher.widget.model.WidgetsListBaseEntry;
import com.yoyo.launcher.widget.model.WidgetsListContentEntry;
import com.yoyo.launcher.widget.model.WidgetsListExpandActionEntry;
...
public class WidgetsListAdapter extends Adapter<ViewHolder> implements OnHeaderClickListener {
    ...
    /** Gets the section name for {@link RecyclerViewFastScroller}. */
