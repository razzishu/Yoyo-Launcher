...
import static com.yoyo.launcher.Utilities.getFullDrawable;
import static com.yoyo.launcher.Utilities.mapToRange;
import static com.yoyo.launcher.graphics.PreloadIconDelegate.newPendingIcon;
import static com.yoyo.launcher.icons.BitmapInfo.FLAG_CUSTOM_SHAPE;
import static com.yoyo.launcher.icons.BitmapInfo.FLAG_FULL_BLEED;
...
import com.yoyo.launcher.util.AsyncView;
...
public class FloatingIconView extends FrameLayout implements
    ...
    private void matchPositionOf(Launcher launcher, View v, boolean isOpening, RectF positionOut) {
        ...
        mClipIconView.setLayoutParams(new LayoutParams(lp.width, lp.height, LEFT));
        mBtvDrawable.setLayoutParams(new LayoutParams(lp.width, lp.height, LEFT));
    }
