...
import static com.yoyo.launcher.BuildConfig.WIDGETS_ENABLED;
import static com.yoyo.launcher.LauncherSettings.Animation.DEFAULT_NO_ICON;
import static com.yoyo.launcher.Utilities.allowBGLaunch;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ALLAPPS_KEYBOARD_CLOSED;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_APP_LAUNCH_PENDING_INTENT;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_APP_LAUNCH_TAP;
...
import com.yoyo.launcher.BaseActivity;
...
import com.yoyo.launcher.util.SplitConfigurationOptions;
import com.yoyo.launcher.util.SystemUiController;
import com.yoyo.launcher.util.ViewCache;
import com.yoyo.launcher.util.WeakCleanupSet;
...
public interface ActivityContext extends SavedStateRegistryOwner {
    ...
    default ActivityOptionsWrapper getActivityLaunchOptions(View v, @Nullable ItemInfo item) {
        ...
        // Use makeScaleUpAnimation instead of makeClipRevealAnimation. 
        // makeClipRevealAnimation calculates its duration dynamically based on the distance 
        // from the screen center, causing icons at the edges to take much longer to settle.
        // makeScaleUpAnimation has a constant unified speed.
