...
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_WORK_UTILITY_VIEW_EXPAND_ANIMATION_BEGIN;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_WORK_UTILITY_VIEW_EXPAND_ANIMATION_END;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_WORK_UTILITY_VIEW_SHRINK_ANIMATION_BEGIN;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_WORK_UTILITY_VIEW_SHRINK_ANIMATION_END;
    ...
    private void animateWorkUtilityViews(boolean isExpanding) {
        ...
        mPauseFABAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                MarginLayoutParams textViewLayoutParams =
                        (MarginLayoutParams) mPauseText.getLayoutParams();
                ...
                MarginLayoutParams iconLayoutParams =
                        (MarginLayoutParams) mWorkIcon.getLayoutParams();
