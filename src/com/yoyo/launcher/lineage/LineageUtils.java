package com.yoyo.launcher.lineage;
...
public class LineageUtils {
    ...
    public static void showLockScreen(Context context, String title, Runnable successRunnable) {
        try {
            ...
            android.util.Log.e("LineageUtils", "Error showing lock screen", e);
            // Fallback to success for standalone builds if biometric fails
            successRunnable.run();
        }
    }
