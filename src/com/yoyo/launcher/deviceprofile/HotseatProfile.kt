...
data class HotseatProfile(
    ...
    companion object Factory {
        fun createHotseatProfile(
            ...
            val isQsbEnabled = inv.enableQsbOnHotseat
            val hotseatQsbHeight = if (isQsbEnabled) res.getDimensionPixelSize(R.dimen.qsb_widget_height) else 0
            val hotseatQsbShadowHeight = if (isQsbEnabled) res.getDimensionPixelSize(R.dimen.qsb_shadow_height) else 0
