    ...
    companion object Factory {
        fun createTaskbarProfile(
            ...
            val transientTaskbarHeight =
                Math.round(
                    (transientTaskbarIconSize * IconNormalizer.ICON_VISIBLE_AREA_FACTOR) +
