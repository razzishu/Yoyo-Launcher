...
package com.yoyo.launcher.deviceprofile
...
import com.yoyo.launcher.Utilities.getIconVisibleSizePx
import com.yoyo.launcher.Utilities.getNormalizedIconDrawablePadding
import com.yoyo.launcher.Utilities.pxFromSp
import com.yoyo.launcher.responsive.CalculatedCellSpec
import com.yoyo.launcher.responsive.CalculatedResponsiveSpec
import com.yoyo.launcher.testing.shared.ResourceUtils.pxFromDp
import com.yoyo.launcher.util.CellContentDimensions
...
data class AllAppsProfile(
    ...
    /**
     * Return a new AllAppsProfile with iconSizePx changed. This function is needed for the java
     * code.
     */
    fun copyWithIconSizePx(newIconSizePx: Int): AllAppsProfile {
        return copy(iconSizePx = newIconSizePx)
    }
