...
import static com.yoyo.launcher.provider.LauncherDbUtils.itemIdMatch;
import static com.yoyo.launcher.util.UserIconInfo.TYPE_CLONED;
import static com.yoyo.launcher.util.UserIconInfo.TYPE_WORK;
...
import com.yoyo.launcher.qsb.QsbContainerView;
...
public class AutoInstallsLayout {
    ...
    protected static String getAttributeValue(XmlPullParser parser, String attribute) {
        String value = parser.getAttributeValue(
                "http://schemas.android.com/apk/res-auto/com.yoyo.launcher", attribute);
        if (value == null) {
