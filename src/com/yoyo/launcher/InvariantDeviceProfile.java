...
import static com.yoyo.launcher.GridType.GRID_TYPE_ANY;
import static com.yoyo.launcher.GridType.GRID_TYPE_NON_ONE_GRID;
import static com.yoyo.launcher.GridType.GRID_TYPE_ONE_GRID;
import static com.yoyo.launcher.LauncherPrefs.ALLAPPS_THEMED_ICONS;
import static com.yoyo.launcher.LauncherPrefs.DB_FILE;
import static com.yoyo.launcher.LauncherPrefs.DRAWER_OPEN_KEYBOARD;
import static com.yoyo.launcher.LauncherPrefs.ENABLE_TWOLINE_ALLAPPS_TOGGLE;
import static com.yoyo.launcher.LauncherPrefs.FIXED_LANDSCAPE_MODE;
import static com.yoyo.launcher.LauncherPrefs.GRID_NAME;
import static com.yoyo.launcher.LauncherPrefs.HOTSEAT_QSB;
import static com.yoyo.launcher.LauncherPrefs.LAUNCHER_LAYOUT;
import static com.yoyo.launcher.LauncherPrefs.NON_FIXED_LANDSCAPE_GRID_NAME;
...
import static com.yoyo.launcher.util.DisplayController.CHANGE_DENSITY;
import static com.yoyo.launcher.util.DisplayController.CHANGE_DESKTOP_MODE;
import static com.yoyo.launcher.util.DisplayController.CHANGE_NAVIGATION_MODE;
import static com.yoyo.launcher.util.DisplayController.CHANGE_SUPPORTED_BOUNDS;
import static com.yoyo.launcher.util.DisplayController.CHANGE_TASKBAR_PINNING;
import static com.yoyo.launcher.util.SimpleBroadcastReceiver.actionsFilter;

import android.content.Context;
import android.content.Intent;
import com.yoyo.launcher.concurrent.annotations.Ui;
...
import com.yoyo.launcher.model.DeviceGridState;
import com.yoyo.launcher.provider.RestoreDbTask;
import com.yoyo.launcher.testing.shared.ResourceUtils;
import com.yoyo.launcher.util.DaggerSingletonObject;
...
import com.yoyo.launcher.util.window.CachedDisplayInfo;
...
public class InvariantDeviceProfile {
    ...
    public boolean enableQsbOnHotseat = true;
    ...
    InvariantDeviceProfile(
        ...
        LauncherPrefChangeListener prefListener = key -> {
            if (FIXED_LANDSCAPE_MODE.getSharedPrefKey().equals(key)
                ...
                onConfigChanged();
                    ...
                    && enableQsbOnHotseat != prefs.get(HOTSEAT_QSB)) {
                onConfigChanged();
            } else if (LAUNCHER_LAYOUT.getSharedPrefKey().equals(key)) {
                String layoutPref = prefs.get(LAUNCHER_LAYOUT);
                String targetGrid = "5_columns".equals(layoutPref) ? "5_by_5" : "4_by_5";
                setCurrentGrid(targetGrid);
            } else if (ALLAPPS_THEMED_ICONS.getSharedPrefKey().equals(key) ||
                    THEMED_ICONS_HOMESCREEN_ONLY.getSharedPrefKey().equals(key) ||
        ...
        prefs.addListener(prefListener, FIXED_LANDSCAPE_MODE, ENABLE_TWOLINE_ALLAPPS_TOGGLE,
                ALLAPPS_THEMED_ICONS, THEMED_ICONS_HOMESCREEN_ONLY, DRAWER_OPEN_KEYBOARD,
                SHOW_DESKTOP_LABELS, SHOW_DRAWER_LABELS, HOTSEAT_QSB, LAUNCHER_LAYOUT);
    ...
    private void initGrid(String gridName) {
        ...
        String targetGridName = (gridName == null || gridName.isEmpty())
                ? ("5_columns".equals(layoutPref) ? "5_by_5" : "4_by_5")
                : gridName;
        ...
        if (!displayOption.grid.name.equals(targetGridName)) {
    ...
    private void initGridForDisplayOption(Info displayInfo, DisplayOption displayOption) {
        ...
        enableQsbOnHotseat = mPrefs.get(HOTSEAT_QSB);
        ...
        float sizeFactor = mPrefs.get(LauncherPrefs.ICON_SIZE_FACTOR);
        float universalIconDp = 56f * sizeFactor;
        Arrays.fill(iconSize, universalIconDp);
        iconBitmapSize = ResourceUtils.pxFromDp(universalIconDp, metrics);
    ...
    public void setCurrentGrid(String newGridName) {
        String layoutVal = "5_by_5".equals(newGridName) ? "5_columns" : "4_columns";
        mPrefs.put(GRID_NAME, newGridName);
        mPrefs.put(LAUNCHER_LAYOUT, layoutVal);
        ...
        try {
            ...
            if (iconSizePx > 0) {
                this.iconSize[InvariantDeviceProfile.INDEX_DEFAULT] =
                        dpiFromPx(iconSizePx, dm.densityDpi);
            }
