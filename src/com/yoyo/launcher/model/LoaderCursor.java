...
import static com.yoyo.launcher.LauncherSettings.Favorites.DESKTOP_ICON_FLAG;
...
import static com.yoyo.launcher.model.data.ItemInfoWithIcon.FLAG_ARCHIVED;
import static com.yoyo.launcher.model.data.WorkspaceItemInfo.FLAG_RESTORED_FULL_BLEED;
...
import com.yoyo.launcher.util.GridOccupancy;
...
public class LoaderCursor extends CursorWrapper {
    ...
    public IconRequestInfo<WorkspaceItemInfo> createIconRequestInfo(
        ...
        byte[] iconBlob = itemType == ITEM_TYPE_DEEP_SHORTCUT || restoreFlag != 0
    ...
    public boolean isOnWorkspaceOrHotseat() {
        return container == CONTAINER_DESKTOP || container == CONTAINER_HOTSEAT;
    }
    ...
    protected boolean checkItemPlacement(ItemInfo item) {
        ...
        if (item.container == CONTAINER_HOTSEAT) {
            final GridOccupancy hotseatOccupancy =
                    mOccupied.get(CONTAINER_HOTSEAT);
            ...
            if (hotseatOccupancy != null) {
                ...
                mOccupied.put(CONTAINER_HOTSEAT, occupancy);
                return true;
            }
        ...
        if (item.container == CONTAINER_DESKTOP && item.cellX < 0 || item.cellY < 0
