...
import static com.yoyo.launcher.model.data.AppInfo.COMPONENT_KEY_COMPARATOR;
import static com.yoyo.launcher.model.data.AppInfo.EMPTY_ARRAY;
...
import com.yoyo.launcher.compat.AlphabeticIndexCompat;
...
import com.yoyo.launcher.model.repository.AppsListRepository;
...
public class AllAppsList {
    ...
    public void add(AppInfo info, LauncherActivityInfo activityInfo, boolean loadIcon) {
        ...
        // Always remove old entry to ensure we don't keep stale/broken data
        data.removeIf(it -> 
                Objects.equals(it.getTargetComponent(), info.componentName) && Objects.equals(it.user, info.user));
