...
import static com.yoyo.launcher.ButtonDropTarget.TOOLTIP_DEFAULT;
import static com.yoyo.launcher.anim.AlphaUpdateListener.updateVisibility;
...
public class DropTargetBar extends FrameLayout
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            Log.e("DropTargetBar", "Error during onMeasure", e);
        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        try {
            ...
            Log.e("DropTargetBar", "Error during onLayout", e);
        }
    }
