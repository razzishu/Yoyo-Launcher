...
import static com.yoyo.launcher.Flags.enableMouseInteractionChanges;
import static com.yoyo.launcher.Flags.injectableModelItems;
...
import static com.yoyo.launcher.graphics.ShapeDelegate.DEFAULT_PATH_SIZE;
...
import static com.yoyo.launcher.util.SplitConfigurationOptions.STAGE_POSITION_BOTTOM_OR_RIGHT;
import static com.yoyo.launcher.util.SplitConfigurationOptions.STAGE_POSITION_TOP_OR_LEFT;
import static com.yoyo.launcher.util.SplitConfigurationOptions.STAGE_TYPE_MAIN;
...
import com.yoyo.launcher.dragndrop.FolderAdaptiveIcon;
import com.yoyo.launcher.graphics.ThemeManager;
import com.yoyo.launcher.graphics.TintedDrawableSpan;
...
import com.yoyo.launcher.icons.IconThemeController;
...
import com.yoyo.launcher.pm.ShortcutConfigActivityInfo;
...
import com.yoyo.launcher.util.SplitConfigurationOptions.SplitPositionOption;
...
public final class Utilities {
     ...
     *
     * see {@link com.yoyo.launcher.dragndrop.DragLayer}.
     *
    ...
    public static <T extends Context & ActivityContext> Pair<AdaptiveIconDrawable, Drawable>
        ...
        if ((info instanceof ItemInfoWithIcon iiwi) && iiwi.bitmap != null
                && !iiwi.getMatchingLookupFlag().useLowRes()) {
        ...
        if (info instanceof PendingAddShortcutInfo) {
            ...
            } else if (info instanceof ItemInfoWithIcon) {
                // Fallback to IconCache if resolveActivity fails
                mainIcon = appState.getIconCache().getFullResIcon(((ItemInfoWithIcon) info).getTargetComponent().getPackageName(), info.user);
            }
            if (mainIcon == null && info instanceof ItemInfoWithIcon) {
                mainIcon = ((ItemInfoWithIcon) info).bitmap.newIcon(context, useTheme ? FLAG_THEMED : 0);
            }
        ...
        if (mainIcon instanceof AdaptiveIconDrawable aid) {
            ...
            result = LauncherIcons.wrapToAdaptiveIcon(context, mainIcon);
        }
        ...
        if (ATLEAST_T && useTheme) {
            ...
            Log.d("Utilities", "getFullDrawable: useTheme=true, themeController=" + themeController);
