 ...
 */
package com.yoyo.launcher.util.window;

import static android.view.Display.DEFAULT_DISPLAY;

import static com.yoyo.launcher.Utilities.dpToPx;
...
import static com.yoyo.launcher.testing.shared.ResourceUtils.NAVBAR_HEIGHT;
import static com.yoyo.launcher.testing.shared.ResourceUtils.NAVBAR_HEIGHT_LANDSCAPE;
import static com.yoyo.launcher.testing.shared.ResourceUtils.NAVBAR_LANDSCAPE_LEFT_RIGHT_SIZE;
import static com.yoyo.launcher.testing.shared.ResourceUtils.NAV_BAR_INTERACTION_MODE_RES_NAME;
import static com.yoyo.launcher.testing.shared.ResourceUtils.STATUS_BAR_HEIGHT;
import static com.yoyo.launcher.testing.shared.ResourceUtils.STATUS_BAR_HEIGHT_LANDSCAPE;
import static com.yoyo.launcher.testing.shared.ResourceUtils.STATUS_BAR_HEIGHT_PORTRAIT;
import static com.yoyo.launcher.util.RotationUtils.deltaRotation;
import static com.yoyo.launcher.util.RotationUtils.rotateRect;
import static com.yoyo.launcher.util.RotationUtils.rotateSize;
...
import com.yoyo.launcher.util.NavigationMode;
...
public class WindowManagerProxy {
    ...
    @Inject
    public WindowManagerProxy(@ApplicationContext Context context) {
        this(context, false);
    }

    protected WindowManagerProxy(@ApplicationContext Context context, boolean taskbarDrawnInProcess) {
