...
public abstract class ButtonDropTarget extends TextView
    ...
    public final void onDragEnter(DragObject d) {
        android.util.Log.d("ButtonDropTarget", "onDragEnter: target=" + mText + " active=" + mActive + " dropEnabled=" + isDropEnabled());
    ...
    public void onDrop(final DragObject d, final DragOptions options) {
        android.util.Log.d("ButtonDropTarget", "onDrop: d=" + d + " options=" + options + " target=" + mText);
        ...
        Runnable onAnimationEndRunnable = () -> {
            android.util.Log.d("ButtonDropTarget", "onDrop: animation end, calling completeDrop");
            completeDrop(d);
