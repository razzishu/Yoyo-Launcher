...
package com.yoyo.launcher.apppairs;
...
/**
 * A {@link FrameLayout} used to represent an app pair icon on the workspace.
 * <br>
...
public class AppPairIcon extends FrameLayout implements DraggableView, Reorderable, Poppable {
    ...
    public static AppPairIcon inflateIcon(int resId, ActivityContext activity,
        ...
        LayoutParams lp =
                (LayoutParams) icon.mAppPairName.getLayoutParams();
