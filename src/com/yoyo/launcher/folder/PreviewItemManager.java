...
import static com.yoyo.launcher.folder.ClippedFolderIconLayoutRule.ENTER_INDEX;
import static com.yoyo.launcher.folder.ClippedFolderIconLayoutRule.EXIT_INDEX;
import static com.yoyo.launcher.folder.ClippedFolderIconLayoutRule.MAX_NUM_ITEMS_IN_PREVIEW;
import static com.yoyo.launcher.folder.FolderIcon.DROP_IN_ANIMATION_DURATION;
...
import com.yoyo.launcher.apppairs.AppPairIconDrawingParams;
import com.yoyo.launcher.apppairs.AppPairIconGraphic;
...
public class PreviewItemManager {
    ...
    ArrayList<PreviewItemDrawingParams> mFirstPageParams = new ArrayList<>();
    // These hold the current page preview items. It is empty if the current page is the first page.
    ArrayList<PreviewItemDrawingParams> mCurrentPageParams = new ArrayList<>();
    ...
    private void setDrawableInternal(
        ...
        int flags = LauncherPrefs.ALLAPPS_THEMED_ICONS.get(mContext) ? FLAG_THEMED : 0;
