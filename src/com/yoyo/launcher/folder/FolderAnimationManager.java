...
import static com.yoyo.launcher.BubbleTextView.TEXT_ALPHA_PROPERTY;
...
import com.yoyo.launcher.anim.PropertyResetListener;
...
public class FolderAnimationManager implements FolderAnimationCreator {
    ...
    public FolderAnimationManager(Folder folder) {
        ...
        mLargeFolderPreviewItemCloseInterpolator = AnimationUtils.loadInterpolator(mContext,
                R.anim.standard_accelerate_interpolator);
    }
     ...
     */
    private static final Property<GradientDrawable, Integer> FOLDER_BG_COLOR =
            new Property<GradientDrawable, Integer>(Integer.class, "color") {
                @Override
                public Integer get(GradientDrawable obj) {
                    // Not used
                    return 0;
                }

                @Override
                public void set(GradientDrawable obj, Integer value) {
                    obj.setColor(value);
                }
            };
    ...
    public AnimatorSet createAnimatorSet(boolean isOpening) {
        ...
        if (initialColor == 0) initialColor = 0xFFEFEDED;
        int finalColor = Themes.getAttrColor(mContext, R.attr.folderBackgroundColor);
        if (finalColor == 0) finalColor = 0xFFEFEDED;

        mFolderBackground.mutate();
        mFolderBackground.setAlpha(230);
        ...
        mBgColorAnimator = getAnimator(mFolderBackground, FOLDER_BG_COLOR, initialColor, finalColor);
        ...
        play(a, getAnimator(mFolder.getFolderName(), ALPHA, 0, 1),
    ...
    private <T> ObjectAnimator getAnimator(T target, Property<T, Integer> property, int v1, int v2) {
        return mIsOpening
                ? ObjectAnimator.ofArgb(target, property, v1, v2)
                : ObjectAnimator.ofArgb(target, property, v2, v1);
    }
    ...
    /**
     * Gets the {@link BubbleTextView} from an icon. In some cases the
