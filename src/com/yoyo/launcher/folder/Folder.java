...
import static com.yoyo.launcher.Flags.enableLauncherVisualRefresh;
...
import static com.yoyo.launcher.compat.AccessibilityManagerCompat.sendCustomAccessibilityEvent;
import static com.yoyo.launcher.config.FeatureFlags.ALWAYS_USE_HARDWARE_OPTIMIZATION_FOR_FOLDER_ANIMATIONS;
import static com.yoyo.launcher.folder.FolderGridOrganizer.createFolderGridOrganizer;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_FOLDER_LABEL_UPDATED;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ITEM_DROP_COMPLETED;
...
import static com.yoyo.launcher.testing.shared.TestProtocol.FOLDER_OPENED_MESSAGE;
import static com.yoyo.launcher.util.window.RefreshRateTracker.getSingleFrameMs;
...
import com.yoyo.launcher.ShortcutAndWidgetContainer;
import com.yoyo.launcher.Utilities;
import com.yoyo.launcher.accessibility.AccessibleDragListenerAdapter;
import com.yoyo.launcher.accessibility.FolderAccessibilityHelper;
import com.yoyo.launcher.anim.KeyboardInsetAnimationCallback;
...
import com.yoyo.launcher.dragndrop.DragController.DragListener;
import com.yoyo.launcher.dragndrop.DragOptions;
import com.yoyo.launcher.graphics.ShapeDelegate;
...
import com.yoyo.launcher.logging.StatsLogManager.StatsLogger;
...
import com.yoyo.launcher.pageindicators.PageIndicatorDots;
...
import com.yoyo.launcher.views.ClipPathView;
...
public class Folder extends AbstractFloatingView implements ClipPathView, DragSource,
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        mBackground.setCornerRadius(getResources().getDimension(R.dimen.bg_round_rect_radius));
        int bgColor = Themes.getAttrColor(context, R.attr.folderBackgroundColor);
        if (bgColor == 0) bgColor = 0xFFEFEDED;
        mBackground.setColor(bgColor);
        mBackground.setAlpha(230); // ~90% transparency
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mBackground.setBounds(0, 0, folderWidth, folderHeight);
    }
    ...
    protected void onDraw(Canvas canvas) {
        // Background is drawn in draw(Canvas)
    }
