...
package com.yoyo.launcher.folder;

import static com.yoyo.launcher.folder.ClippedFolderIconLayoutRule.ICON_OVERLAP_FACTOR;
import static com.yoyo.launcher.folder.ClippedFolderIconLayoutRule.MAX_NUM_ITEMS_IN_PREVIEW;
import static com.yoyo.launcher.folder.FolderGridOrganizer.createFolderGridOrganizer;
import static com.yoyo.launcher.folder.PreviewItemManager.INITIAL_ITEM_ANIMATION_DURATION;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_FOLDER_AUTO_LABELED;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_FOLDER_AUTO_LABELING_SKIPPED_EMPTY_PRIMARY;
import static com.yoyo.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_FOLDER_AUTO_LABELING_SKIPPED_EMPTY_SUGGESTIONS;
import static com.yoyo.launcher.model.data.FolderInfo.willAcceptItemType;
...
import com.yoyo.launcher.Alarm;
import com.yoyo.launcher.BubbleTextView;
import com.yoyo.launcher.CellLayout;
import com.yoyo.launcher.CheckLongPressHelper;
...
import com.yoyo.launcher.OnAlarmListener;
import com.yoyo.launcher.R;
import com.yoyo.launcher.Reorderable;
...
import com.yoyo.launcher.dot.FolderDotInfo;
import com.yoyo.launcher.dragndrop.BaseItemDragListener;
...
import com.yoyo.launcher.logger.LauncherAtom.FromState;
import com.yoyo.launcher.logger.LauncherAtom.ToState;
...
import com.yoyo.launcher.model.data.FolderInfo.LabelState;
...
public class FolderIcon extends FrameLayout implements FloatingIconViewCompanion,
    ...
    public void drawDot(Canvas canvas) {
        if (!mForceHideDot && ((mDotInfo != null && mDotInfo.hasDot()) || mDotScale > 0)) {
            ...
            PreviewItemDrawingParams p = null;
            for (PreviewItemDrawingParams itemParams : mPreviewItemManager.mFirstPageParams) {
                if (itemParams.item != null && mActivity.getDotInfoForItem(itemParams.item) != null) {
                    p = itemParams;
                    break;
                }
            }
            ...
            if (p != null) {
                float intrinsicSize = mPreviewItemManager.getIntrinsicIconSize();
                float scaledSize = intrinsicSize * p.scale;
                float offsetX = mBackground.basePreviewOffsetX;
                float offsetY = mBackground.basePreviewOffsetY;

                iconBounds.left = (int) (offsetX + p.transX);
                iconBounds.top = (int) (offsetY + p.transY);
                iconBounds.right = (int) (iconBounds.left + scaledSize);
                iconBounds.bottom = (int) (iconBounds.top + scaledSize);
            } else {
                // Fallback to top-aligned & horizontally-centered calculation
