...
public final class Interpolators {
    ...
    public static final Interpolator DECELERATE_QUINT = input -> 1f - (float) Math.pow(1f - input, 5);
    ...
    public static final Interpolator SCROLL_CUBIC = input -> 1f - (float) Math.pow(1f - input, 3);
    ...
    public static Interpolator clampToProgress(TimeInterpolator interpolator, float lowerBound, float upperBound) {
        return input -> {
    ...
    public static Interpolator mapToProgress(TimeInterpolator interpolator, float lowerBound, float upperBound) {
